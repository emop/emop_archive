        ...
        <div id="pics" class="carousel slide" data-ride="carousel">            
              ...
              <?php foreach ($data['scheme_detail']['scheme_detail']['img_list'] as $k=>$img){?>
                <div class="item <?=$k === 0 ?'active':''?>">
                  <img src="<?=host_url().$data['scheme']['scheme_path']."/".$img['img']?>" alt="">
       	...
       	<p class="button"><a href="<?=$host.'theme_install?scheme_id='.$data['scheme']['scheme_id']?>" class="btn btn-lg btn-block btn-success" role="button">安装</a></p>
